...
% Prints the text of the file dedication.tex centered vertically on the page.
	...
	For my grandmother, Theodora, who taught me to trust in God.
        ...
        And for my mother, Susan, who taught me to see through all the bullshit.
	\vspace*{\fill} 
\end{dedication}
...
\chapter{Disciplinary Bridge: Regulating Information}~\label{chapter:bridge}
...
\chapter{Origin Privacy: Causality and Data Protection}~\label{chapter:origin-privacy}
	\subfile{chapters/chapter2}
        ...
        \chapter[Games and Rules]{Data Games and the Value of Information}~\label{chapter:games-and-rules}
