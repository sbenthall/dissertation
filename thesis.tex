...
\numberofmembers{4} 
\chair{John Chuang}
\othermemberA{Deirdre Mulligan, co-Chair}
\othermemberB{Helen Nissenbaum}
\othermemberC{David Wagner} 
...
% Prints the text of the file dedication.tex centered vertically on the page.
	...
	To my grandmother, Theodora, who taught me to trust in God
        ...
        To my father, Timothy, who taught me that God is logic

        To my mother, Susan, who taught me that it's not worth doing a dissertation if it's bullshit
	\vspace*{\fill} 
\end{dedication}
...
\chapter{Chapter 2}~\label{chapter:background}
