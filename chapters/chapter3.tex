...
(see Figure \ref{fig:optional-edge}).
...
We can model this interaction with the graphin Figure \ref{fig:principal-agent}.
...
and is shown here again as Figure \ref{fig:expert-data-game}.
